 ...
 * Author:      Pengzhi Sun
 * Description: .Net Core dependency inversion demos.
 *****************************************************************************/
...
namespace DotNetCoreBootstrap.DIDemo
{
    ...
    internal static class Program
    {
        ...
        {
            PrintMessageBlock("Begin .Net Core Dependency Inversion Demos", '#');

            RunDemo("UnityDemo", UnityDemo.Run);

            PrintMessageBlock("End .Net Core Dependency Inversion Demos", '#');
        }
